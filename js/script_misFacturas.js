...
const names = ['Razon de servicios', 'Registro de Prestadoras de Servicios Especializados u Obras Especializadas', 'Comprobantes fiscales por concepto de salarios al personal involucrado '
                , 'Acuse de recibo y Declaración Mensual de Retenciones de Impuesto Sobre la Renta (ISR)', 'Pago de Cuotas al Instituto Mexicano del Seguro Social (IMSS) ',
